...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        //        'salespersonMiddleware' => \App\Http\Middleware\SalespersonMiddleware::class,
        //        'productmanagerMiddleware' => \App\Http\Middleware\ProductmanagerMiddleware::class,
        //        'pricemanagerMiddleware' => \App\Http\Middleware\PricemanagerMiddleware::class,
        //        'telecallerMiddleware' => \App\Http\Middleware\TelecallerMiddleware::class,
