...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('storeClientPoc') }}" method="post" id="poc_profile_form">
                @csrf
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="form-control form-control-sm select2" id="poc_designation" name="poc_designation">
                                <option value="" disabled hidden selected>Choose...</option>
                                @foreach ($designation as $designation)
                                    <option value="{{ $designation->designation_id }}">{{ ucfirst($designation->designation_title) }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
...
@section('javascript')
    <script>
        ...
        //     let poc_comp = document.getElementById("poc_comp"),
        //         poc_name = document.getElementById("poc_name"),
        //         poc_mob = document.getElementById("poc_mob"),
        //         poc_w_mob = document.getElementById("poc_w_mob"),
        //         poc_email = document.getElementById("poc_email"),
        //         poc_designation = document.getElementById("poc_designation"),
        ...
        //     if (poc_comp.value == '') {
        //         poc_comp.nextSibling.childNodes[0].childNodes[0].style.border = "1px solid red"
        //         return false;
        //     }
        //     if (ok) {
