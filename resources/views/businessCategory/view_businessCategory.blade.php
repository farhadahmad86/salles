...
@section('content')
    <div class="card collapsed-card mt-3">
        ...
        <div class="card-body">
            <form class="prnt_lst_frm" action="{{ route('view_businessCategory') }}">
                <div class="row">
                    <div class="col-md-2">
                ...
                <div class="row mt-3 mb-3">
                    <div class="filter_buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="col-md-1"><a href="{{ route('view_businessCategory') }}" name="refresh"
                                    id="refresh" class="btn btn-primary"><i class="fas fa-sync"></i></a></div>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <div class="card mt-4">
        <div class="card-header">Business Category</div>
        <div class="card-body table-responsive">
            @include('print.pages.p_businessCategory')
        </div>
    </div>
@endsection
...
@section('javascript')
    <script>
        ...
        var base = '{{ route('view_businessCategory') }}',
            url;
