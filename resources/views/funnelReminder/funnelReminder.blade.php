...
@section('content')
                ...
                <div class="row mt-3 mb-3">
                    <div class="filter_buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="col-md-1"><a href="{{ route('funnelReminder') }}" name="refresh" id="refresh"
    ...
    <div class="card mt-5">
        <div class="card-header">Funnel Reminder</div>
        <div class="card-body table-responsive">
        @include('print.pages.p_funnel_reminder')
...
@section('javascript')
    <script>
        ...
        var base = '{{ route('funnelReminder') }}',url;
        ...
        //     $.ajax({
        //         url: '/reminder_funnel_advance_search',
        //         type: 'get',
        //         data: {
        //             companies: companies,
