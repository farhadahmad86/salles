...
@section('content')
    <div class="card collapsed-card">
        ...
        <div class="card-body">
            <form class="prnt_lst_frm" action="{{route('allInvoices')}}">
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-1">
                        ...
                        <input type="text" name="from_date" value="{{$from_date}}" class="form-control date advance_search form-control-sm from_date" id="" placeholder="Choose...">
                    </div>
                    <div class="col-md-1">
                        <label for="">To Date</label>
                        <input type="text" name="to_date" value="{{$to_date}}" class="form-control date advance_search form-control-sm to_date" id="" placeholder="Choose...">
                    </div>
                    <div class="col-md-2">
...
{{--    Reminder--}}
    @foreach($datas as $info)
        <div class="modal fade reminder_no_{{$info->invoice_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('purposal_reminder')}}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">Choose Reminder Date</label>
                                        <input type="text" class="form-control purposal_datetime" placeholder="Choose Date" name="reminder_date">
                                    </div>
                                </div>
...
{{--    @endforeach--}}
    ...
    {{--    Remarks--}}
    @foreach($datas as $info)
        <div class="modal fade remarks_no_{{$info->invoice_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control purposal_datetime" placeholder="Choose Date" name="remarks_date" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
    ...
    {{--    Showing Invoices--}}
    @foreach($datas as $info)
        <div class="modal fade invoice_modal_{{$info->invoice_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<script>
        ...
        var base = '{{ route('allInvoices') }}',url;
