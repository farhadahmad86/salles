...
@section('content')
    <div class="card collapsed-card">
        ...
        <div class="card-body">
            <form class="prnt_lst_frm" action="{{ route('mainUnit') }}">
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <select id="main_unit" class="form-control form-control-sm advance_search" name="main_unit">
                            ...
                            @foreach ($all_main_unit as $item)
                                <option value="{{ $item->main_unit_id }}"
                                    {{ $item->main_unit_id == $main_unit ? 'selected' : '' }}>{{ $item->main_unit_name }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="row mt-3 mb-3">
                    <div class="filter_buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="col-md-1"><a href="{{ route('mainUnit') }}" name="refresh" id="refresh"
    ...
    <div class="card mt-4">
        <div class="card-header">Main Unit</div>
        <div class="card-body table-responsive">
            @include('print.pages.p_mainUnit')
        </div>
    </div>
@endsection
