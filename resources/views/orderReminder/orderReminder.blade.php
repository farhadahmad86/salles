...
@section('content')
                ...
                <div class="row mt-3 mb-3">
                    <div class="filter_buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="col-md-1"><a href="{{ route('orderReminder') }}" name="refresh" id="refresh"
    ...
    <div class="card mt-5">
        ...
        <div class="card-body table-responsive">
            @include('print.pages.p_order_reminder')
...
@section('javascript')
    <script>
        ...
        //     $.ajax({
        //         url: '/reminder_order_advance_search',
        //         type: 'get',
        //         data: {
        //             companies: companies,
        ...
        var base = '{{ route('orderReminder') }}',url;
