        ...
        <table class="table" id="myTable">
            <thead>
                <tr>
                    ...
                    <th onclick="sortTable(3)">Reminder Remarks</th>
                    <th onclick="sortTable(4)">Grand Total</th>
                    <th onclick="sortTable(5)">Created By</th>
                    <th onclick="sortTable(6)">Created For</th>
                        ...
                        @if (empty($type))
                            @if ($reminder->reminder_reason == null)
                                <td style="text-align: center">
                                    ...
                                    <a href="{{ route('delete_order_reminder', 'reminder_id=' . $reminder->reminder_id) }}"
