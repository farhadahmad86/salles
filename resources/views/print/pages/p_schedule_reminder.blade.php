                        ...
                        @if (empty($type))
                            @if ($reminder->reminder_reason == null && $reminder->reminder_user_id == Auth::user()->id)
                                <td style="text-align: center">
                                    ...
                                    <a href="{{ route('delete_schedule_reminder', 'reminder_id=' . $reminder->reminder_id) }}"
