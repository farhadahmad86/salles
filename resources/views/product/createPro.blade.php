...
@section('content')
    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <form action="{{ route('storeProduct') }}" method="post" id="product_form">
                @csrf
                <div class="row">
                    <div class="col-md-2">
                                ...
                                <select class="form-control form-control-sm select2" name="pro_group" id="product_group">
                                    ...
                                    @foreach ($pro_group as $pro_groups)
                                        <option value="{{ $pro_groups->product_group_id }}">
                                            {{ $pro_groups->product_group_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <select class="form-control form-control-sm select2" name="category" id="product_category">
                                    {{-- @foreach ($categories as $cat)
                                        <option value="{{ $cat->cat_id }}"
                                            {{ old('category') == $cat->cat_id ? 'selected' : '' }}>{{ $cat->cat_category }}
                                        </option>
                                    @endforeach --}}
                                </select>
                            </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" id="" name="productName"
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="editor" class="form-control form-control-sm textarea" cols="500"
...
@section('javascript')
    ...
    <script>
        ...
        // farhad
        // (show category after click on product Group)
