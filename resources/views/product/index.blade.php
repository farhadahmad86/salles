...
@section('content')
    <div class="card collapsed-card">
        ...
        <div class="card-body">
            <form class="prnt_lst_frm" action="{{ route('product') }}">
                <div class="row">
                    <div class="col-md-2">
                ...
                <div class="row mt-3 mb-3">
                    <div class="filter_buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="col-md-1"><a href="{{ route('product') }}" name="refresh" id="refresh"
