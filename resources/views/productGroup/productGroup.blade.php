...
@section('content')
    <div class="card collapsed-card">
        ...
        <div class="card-body">
            <form class="prnt_lst_frm" action="{{ route('productGroup') }}">
                <div class="row">
                    <div class="col-md-2">
                ...
                <div class="row mb-3 mt-3">
                    <div class="filter_buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="col-md-1"><a href="{{ route('productGroup') }}" name="refresh" id="refresh"
    ...
    <div class="card mt-4">
        ...
        <div class="card-body table-responsive">
            @include('print.pages.p_productGroup')
        </div>
    </div>
@endsection
