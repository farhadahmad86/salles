...
@section('content')
                ...
                <div class="row mt-3 mb-3">
                    <div class="filter_buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="col-md-1">
                                <a href="{{ route('purposalRemarks') }}" name="refresh" id="refresh"
    ...
    <div class="card">
        <div class="card-header">Purposal Reminder</div>
        <div class="card-body table-responsive">
            @include('print.pages.p_invoice_remarks')
...
@section('javascript')
    <script>
        ...
        var base = '{{ route('purposalRemarks') }}',
            url;
        ...
        //     $.ajax({
        //         url: '/remarks_quotation_advance_search',
        //         type: 'get',
        //         data: {
        //             companies: companies,
