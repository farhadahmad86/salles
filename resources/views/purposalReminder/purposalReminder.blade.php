...
@section('content')
    <div class="card collapsed-card">
        ...
        <div class="card-body">
            <form class="prnt_lst_frm" action="{{route('purposalReminder')}}">
                <div class="row">
                    <div class="col-md-2">
                        <label for="">Companies</label>
                        <select id="companies" class="form-control form-control-sm advance_search" name="companies">
                            <option selected value="0">All</option>
                            @foreach($purposal_reminder as $item)
                                <option value="{{$item->company_name}}" {{$item->company_name == $companies ? 'selected' : ''}}>{{$item->company_name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="row mt-3 mb-3">
                    <div class="filter_buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="col-md-1"><a href="{{ route('purposalReminder') }}" name="refresh" id="refresh"
    ...
    <div class="card mt-5">
        <div class="card-header">Quotation Reminder</div>
        <div class="card-body table-responsive">
            @include('print.pages.p_invoice_reminder')
...
@section('javascript')
    <script>
        ...
        var base = '{{ route('purposalReminder') }}',url;
        ...
        //     $.ajax({
        //         url: '/reminder_quotation_advance_search',
        //         type: 'get',
        //         data: {
        //             companies: companies,
