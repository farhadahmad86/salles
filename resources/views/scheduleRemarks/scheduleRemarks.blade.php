...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        ...
                        <select id="visit_type" class="form-control form-control-sm advance_search" name="visit_type">
                            <option selected value="0">All</option>
                            @foreach ($sch_remarks as $item)
                                <option value="{{ $item->visit_type_id }}" {{ $item->id == $visit_type ? 'selected' : '' }}>
                                    {{ $item->visit_type_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-1">
                ...
                <div class="row mt-3 mb-3">
                    <div class="filter_buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="col-md-1">
                                <a href="{{ route('scheduleRemarks') }}" name="refresh" id="refresh"
    ...
    <div class="card">
        <div class="card-header">Schedule Remarks</div>
        <div class="card-body table-responsive">
            @include('print.pages.p_schedule_remarks')
...
@section('javascript')
    <script>
        ...
        var base = '{{ route('scheduleRemarks') }}',
            url;
        ...
        //     $.ajax({
        //         url: '/remarks_schedule_advance_search',
        //         type: 'get',
        //         data: {
        //             companies: companies,
