...
@section('content')
    <div class="card collapsed-card">
        ...
        <div class="card-body">
            <form class="prnt_lst_frm" action="{{ route('uom') }}">
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        ...
                        <select id="unit" class="form-control form-control-sm advance_search" name="unit">
                            ...
                            @foreach ($all_unit as $item)
                                <option value="{{ $item->unit_id }}" {{ $item->unit_id == $unit ? 'selected' : '' }}>
                ...
                <div class="row mt-3 mb-3">
                    <div class="filter_buttons">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="col-md-1"><a href="{{ route('uom') }}" name="refresh" id="refresh"
