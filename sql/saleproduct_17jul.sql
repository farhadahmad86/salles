...
(
    area_id         int(255) auto_increment
        primary key,
    area_region_id  varchar(255)                            null,
...
(
    cat_product_grp_id int auto_increment
        primary key,
    product_cat_id     varchar(255) null,
    product_grp_id     varchar(255) null
);
...
(
    ...
    cat_product_group_id varchar(255)                            null,
...
(
    main_unit_id         int(255) auto_increment
        primary key,
    main_unit_user_id    int(255)                                null,
    main_unit_name       varchar(255)                            null,
    main_unit_remarks    varchar(255)                            null,
    main_unit_created_at timestamp default current_timestamp()   null on update current_timestamp(),
    main_unit_updated_at timestamp default '0000-00-00 00:00:00' null,
    ip_address           varchar(255)                            null,
    os_name              varchar(255)                            null,
    browser              varchar(255)                            null,
    device               varchar(255)                            null
...
(
    product_group_id         int(255) auto_increment
        primary key,
    product_group_user_id    int(255)                                null,
    product_group_name       varchar(255)                            null,
    product_group_remarks    varchar(255)                            null,
    ip_address               varchar(255)                            null,
    os_name                  varchar(255)                            null,
    browser                  varchar(255)                            null,
    device                   varchar(255)                            null,
    product_group_created_at timestamp default current_timestamp()   null on update current_timestamp(),
    product_group_updated_at timestamp default '0000-00-00 00:00:00' null
)
    engine = InnoDB;

create table product_group_target
(
    product_group_target_id           int(255) auto_increment
        primary key,
    product_group_target_your_manager varchar(255)                            null,
    product_group_target_user_id      varchar(255)                            null,
    product_group_target_by           int(255)                                null,
    product_group_target              varchar(255)                            null,
    product_group_target_date         varchar(255)                            null,
    product_group_target_role         varchar(255)                            null,
    product_group_target_created_at   timestamp default current_timestamp()   not null on update current_timestamp(),
    product_group_target_updated_at   timestamp default '0000-00-00 00:00:00' not null,
    ip_address                        varchar(255)                            null,
    os_name                           varchar(255)                            null,
    browser                           varchar(255)                            null,
    device                            varchar(255)                            null
...
(
    ...
    product_price_unit       varchar(255)                            null,
...
(
    ...
    browser           varchar(255)                          null,
    device            varchar(255)                          null,
    tandc_user_id     varchar(255)                          null
)
    engine = InnoDB;
...
create table town
(
    town_id         int(255) auto_increment
        primary key,
    town_region_id  int(255)                                null,
    town_area_id    int(255)                                null,
    town_sector_id  int(255)                                null,
    town_user_id    int(255)                                null,
    town_name       varchar(255)                            null,
    town_remarks    varchar(255)                            null,
    town_created_at timestamp default current_timestamp()   null on update current_timestamp(),
    town_updated_at timestamp default '0000-00-00 00:00:00' null,
    ip_address      varchar(255)                            null,
    os_name         varchar(255)                            null,
    browser         varchar(255)                            null,
    device          varchar(255)                            null
...
create table unit
(
    unit_id           int(255) auto_increment
        primary key,
    unit_user_id      int(255)                                null,
    unit_main_unit_id varchar(255)                            null,
    unit_name         varchar(255)                            null,
    unit_scale_size   varchar(255)                            null,
    unit_remarks      varchar(255)                            null,
    ip_address        varchar(255)                            null,
    os_name           varchar(255)                            null,
    browser           varchar(255)                            null,
    device            varchar(255)                            null,
    unit_created_at   timestamp default current_timestamp()   null on update current_timestamp(),
    unit_updated_at   timestamp default '0000-00-00 00:00:00' null
)
    engine = InnoDB;
